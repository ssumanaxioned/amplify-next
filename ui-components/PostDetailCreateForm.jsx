...
export default function PostDetailCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPostDetailPostId(initialValues.postDetailPostId);
    setErrors({});
  };
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(new PostDetail(modelFields));
          if (onSuccess) {
      ...
      {...rest}
      {...getOverrideProps(overrides, "PostDetailCreateForm")}
    >
      <TextField
        label="Title"
        isRequired={true}
