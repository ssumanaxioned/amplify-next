...
export default function PagesUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = { ...initialValues, ...pagesRecord };
    setSlug(cleanValues.slug);
    setTitle(cleanValues.title);
    setErrors({});
  };
  const [pagesRecord, setPagesRecord] = React.useState(pages);
  React.useEffect(() => {
    const queryData = async () => {
      const record = id ? await DataStore.query(Pages, id) : pages;
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(
            Pages.copyOf(pagesRecord, (updated) => {
